...
export default function SimpleFacialForm() {
  const [formData, setFormData] = useState({
    ...
    tipoPiel: [] as string[],
    fototipo: '',
    condicionesPiel: [] as string[],
    zonasInteres: [] as string[],
  ...
  const [photos, setPhotos] = useState({
    ...
    lateralDerecho: null as string | null,
    lateralIzquierdo: null as string | null
  });
    ...
    <div className="max-w-4xl mx-auto p-6 space-y-8">
        ...
        <CardContent className="space-y-4">
          ...
          <div>
            ...
            >
              ...
              <div className="flex items-center space-x-2">
                <RadioGroupItem value="mas8hrs" id="sueno-8plus" />
                <Label htmlFor="sueno-8plus">Más de 8 hrs</Label>
              </div>
            </RadioGroup>
          </div>
          ...
          <div>
            ...
            >
              <div className="flex items-center space-x-2">
                <RadioGroupItem value="menos1L" id="hidratacion-1" />
                <Label htmlFor="hidratacion-1">Menos de 1L</Label>
              </div>
              <div className="flex items-center space-x-2">
              ...
              <div className="flex items-center space-x-2">
                <RadioGroupItem value="mas2L" id="hidratacion-3" />
                <Label htmlFor="hidratacion-3">Más de 2L de agua al día</Label>
              </div>
            </RadioGroup>
          </div>
        </CardContent>
      ...
      <Card>
        <CardHeader>
          ...
          <p className="text-sm text-gray-600">(Señalar una o varias)</p>
        </CardHeader>
        <CardContent>
      ...
      <Card>
        <CardHeader>
          ...
          <p className="text-sm text-gray-600">(Rellena el médico/esteticista)</p>
        </CardHeader>
        <CardContent className="space-y-4">
          <div>
